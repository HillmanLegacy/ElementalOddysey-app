...
export const PARTY_SPRITE_DATA: Record<string, PartySpriteData> = {
  samurai: {
    idle: { sheet: "samurai-idle.png", frameWidth: 27, frameHeight: 38, totalFrames: 10 },
    attack: { sheet: "samurai-attack.png", frameWidth: 61, frameHeight: 37, totalFrames: 7 },
    run: { sheet: "samurai-run.png", frameWidth: 38, frameHeight: 35, totalFrames: 16 },
    hurt: { sheet: "samurai-hurt.png", frameWidth: 27, frameHeight: 38, totalFrames: 4 },
  },
  knight: {
    idle: { sheet: "knight-idle-4f.png", frameWidth: 46, frameHeight: 41, totalFrames: 7 },
    attack: { sheet: "knight-attack.png", frameWidth: 86, frameHeight: 49, totalFrames: 7 },
    run: { sheet: "knight-run.png", frameWidth: 46, frameHeight: 41, totalFrames: 6 },
    walk: { sheet: "knight-walk.png", frameWidth: 46, frameHeight: 41, totalFrames: 4 },
    hurt: { sheet: "knight-hurt.png", frameWidth: 46, frameHeight: 41, totalFrames: 2 },
  },
  ranger: {
    idle: { sheet: "ranger-idle.png", frameWidth: 64, frameHeight: 33, totalFrames: 6 },
    attack: { sheet: "ranger-attack.png", frameWidth: 64, frameHeight: 41, totalFrames: 6 },
    run: { sheet: "ranger-run.png", frameWidth: 64, frameHeight: 36, totalFrames: 6 },
    hurt: { sheet: "ranger-hurt.png", frameWidth: 64, frameHeight: 36, totalFrames: 6 },
  },
  basken: {
    idle: { sheet: "basken-idle.png", frameWidth: 26, frameHeight: 34, totalFrames: 5 },
    attack: { sheet: "basken-attack.png", frameWidth: 50, frameHeight: 36, totalFrames: 8 },
    run: { sheet: "basken-run.png", frameWidth: 29, frameHeight: 35, totalFrames: 6 },
    hurt: { sheet: "basken-hurt.png", frameWidth: 28, frameHeight: 34, totalFrames: 3 },
  },
  knight2d: {
    idle: { sheet: "knight2d-idle.png", frameWidth: 84, frameHeight: 39, totalFrames: 8 },
    attack: { sheet: "knight2d-attack-1.png", frameWidth: 84, frameHeight: 38, totalFrames: 6 },
    run: { sheet: "knight2d-run.png", frameWidth: 84, frameHeight: 40, totalFrames: 9 },
    hurt: { sheet: "knight2d-hurt.png", frameWidth: 51, frameHeight: 38, totalFrames: 4 },
  },
  axewarrior: {
    idle: { sheet: "axewarrior-idle.png", frameWidth: 54, frameHeight: 66, totalFrames: 6 },
    attack: { sheet: "axewarrior-attack.png", frameWidth: 94, frameHeight: 91, totalFrames: 13 },
    run: { sheet: "axewarrior-run.png", frameWidth: 75, frameHeight: 63, totalFrames: 8 },
    hurt: { sheet: "axewarrior-hurt.png", frameWidth: 60, frameHeight: 69, totalFrames: 3 },
  },
};
