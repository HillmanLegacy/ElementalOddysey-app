...
export const REGIONS: Region[] = [
  {
    ...
    unlocked: true,
    nodes: [
      { id: 0,  type: "hut",     name: "Ember Hut",           x: 5,  y: 50, connections: [1],         region: 0, cleared: false },
      { id: 1,  type: "passage", name: "Scorched Path",        x: 17, y: 50, connections: [0, 2, 3],   region: 0, cleared: false },
      { id: 2,  type: "shaman",  name: "Fire Shaman's Hut",    x: 17, y: 25, connections: [1],         region: 0, cleared: false },
      { id: 3,  type: "passage", name: "Cinder Trail",         x: 31, y: 50, connections: [1, 4, 5],   region: 0, cleared: false },
      { id: 4,  type: "passage", name: "Ash Hollow",           x: 31, y: 75, connections: [3],         region: 0, cleared: false },
      { id: 5,  type: "shop",    name: "Merchant Camp",        x: 46, y: 50, connections: [3, 6, 7],   region: 0, cleared: false },
      { id: 6,  type: "passage", name: "Flame Ridge",          x: 46, y: 25, connections: [5],         region: 0, cleared: false },
      { id: 7,  type: "rest",    name: "Hot Spring",           x: 60, y: 50, connections: [5, 8, 9],   region: 0, cleared: false },
      { id: 8,  type: "passage", name: "Lava Flow",            x: 60, y: 75, connections: [7],         region: 0, cleared: false },
      { id: 9,  type: "passage", name: "Inferno Gorge",        x: 74, y: 50, connections: [7, 11, 12, 13], region: 0, cleared: false },
      { id: 11, type: "passage", name: "Magma Cavern",         x: 74, y: 25, connections: [9],         region: 0, cleared: false },
      { id: 12, type: "shop",    name: "Smolder Market",       x: 74, y: 75, connections: [9],         region: 0, cleared: false },
      { id: 13, type: "boss",    name: "Dragon Lord's Sanctum",x: 90, y: 50, connections: [9],         region: 0, cleared: false },
    ],
  },
  {
    id: 1,
    ...
    nodes: [
      ...
      { id: 11, type: "passage", name: "Frost Gate", x: 20, y: 65, connections: [10, 13, 14], region: 1, cleared: false },
      { id: 12, type: "passage", name: "Icicle Path", x: 12, y: 55, connections: [10, 15], region: 1, cleared: false },
      { id: 13, type: "passage", name: "Glacier Pass", x: 32, y: 75, connections: [11, 16], region: 1, cleared: false },
      { id: 14, type: "shop", name: "Ice Merchant", x: 30, y: 52, connections: [11, 15, 17], region: 1, cleared: false },
      { id: 15, type: "passage", name: "Frozen Falls", x: 24, y: 38, connections: [12, 14, 18], region: 1, cleared: false },
      { id: 16, type: "passage", name: "Blizzard Peak", x: 45, y: 68, connections: [13, 19], region: 1, cleared: false },
      { id: 17, type: "passage", name: "Crystal Cavern", x: 44, y: 45, connections: [14, 19, 20], region: 1, cleared: false },
      ...
      { id: 20, type: "passage", name: "Permafrost Depths", x: 52, y: 32, connections: [17, 18, 22], region: 1, cleared: false },
      { id: 21, type: "passage", name: "Avalanche Ridge", x: 70, y: 52, connections: [19, 22, 23], region: 1, cleared: false },
      { id: 22, type: "passage", name: "Ice Throne Path", x: 68, y: 35, connections: [20, 21, 23], region: 1, cleared: false },
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: 21, type: "passage", name: "Dark Entrance", x: 20, y: 62, connections: [20, 23, 24], region: 2, cleared: false },
      { id: 22, type: "passage", name: "Twilight Trail", x: 15, y: 48, connections: [20, 25], region: 2, cleared: false },
      { id: 23, type: "passage", name: "Mist Trail", x: 34, y: 72, connections: [21, 26], region: 2, cleared: false },
      { id: 24, type: "shop", name: "Shade Dealer", x: 32, y: 50, connections: [21, 25, 27], region: 2, cleared: false },
      { id: 25, type: "passage", name: "Phantom Woods", x: 25, y: 35, connections: [22, 24, 28], region: 2, cleared: false },
      { id: 26, type: "passage", name: "Cursed Bog", x: 48, y: 66, connections: [23, 29], region: 2, cleared: false },
      { id: 27, type: "passage", name: "Specter Hollow", x: 46, y: 42, connections: [24, 29, 30], region: 2, cleared: false },
      ...
      { id: 30, type: "passage", name: "Void Corridor", x: 54, y: 30, connections: [27, 28, 32], region: 2, cleared: false },
      { id: 31, type: "passage", name: "Nightmare Fen", x: 72, y: 50, connections: [29, 32, 33], region: 2, cleared: false },
      { id: 32, type: "passage", name: "Abyssal Gate", x: 70, y: 32, connections: [30, 31, 33], region: 2, cleared: false },
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: 31, type: "passage", name: "Sand Gate", x: 22, y: 62, connections: [30, 33, 34], region: 3, cleared: false },
      { id: 32, type: "passage", name: "Dust Trail", x: 16, y: 48, connections: [30, 35], region: 3, cleared: false },
      { id: 33, type: "passage", name: "Dune Path", x: 36, y: 74, connections: [31, 36], region: 3, cleared: false },
      { id: 34, type: "shop", name: "Oasis Market", x: 34, y: 48, connections: [31, 35, 37], region: 3, cleared: false },
      { id: 35, type: "passage", name: "Sandstorm Gulch", x: 26, y: 34, connections: [32, 34, 38], region: 3, cleared: false },
      { id: 36, type: "passage", name: "Crystal Wastes", x: 50, y: 68, connections: [33, 39], region: 3, cleared: false },
      { id: 37, type: "passage", name: "Mirage Ruins", x: 48, y: 42, connections: [34, 39, 40], region: 3, cleared: false },
      ...
      { id: 40, type: "passage", name: "Titan's Canyon", x: 56, y: 30, connections: [37, 38, 42], region: 3, cleared: false },
      { id: 41, type: "passage", name: "Quartz Valley", x: 74, y: 52, connections: [39, 42, 43], region: 3, cleared: false },
      { id: 42, type: "passage", name: "Obsidian Gate", x: 72, y: 34, connections: [40, 41, 43], region: 3, cleared: false },
...
export const REGION_TIER_VARIANTS: Record<number, Record<number, Region>> = {
  0: {
    1: {
      ...
      unlocked: true,
      nodes: [
        { id: 0, type: "hut", name: "Charred Outpost", x: 50, y: 88, connections: [1, 2, 3], region: 0, cleared: false },
        { id: 1, type: "passage", name: "Sulfur Flats", x: 28, y: 72, connections: [0, 4], region: 0, cleared: false },
        { id: 2, type: "passage", name: "Magma Shelf", x: 50, y: 68, connections: [0, 5], region: 0, cleared: false },
        { id: 3, type: "passage", name: "Obsidian Crossing", x: 72, y: 72, connections: [0, 6], region: 0, cleared: false },
        { id: 4, type: "shop", name: "Forgemaster's Market", x: 15, y: 52, connections: [1, 7], region: 0, cleared: false },
        { id: 5, type: "rest", name: "Lava Spring", x: 45, y: 48, connections: [2, 7, 8, 9], region: 0, cleared: false },
        { id: 6, type: "passage", name: "Pyroclast Ridge", x: 82, y: 52, connections: [3, 9], region: 0, cleared: false },
        { id: 7, type: "passage", name: "Smelter Ruins", x: 22, y: 35, connections: [4, 5, 10], region: 0, cleared: false },
        { id: 8, type: "shaman", name: "Flame Oracle's Cave", x: 55, y: 30, connections: [5, 11], region: 0, cleared: false },
        { id: 9, type: "passage", name: "Crucible Depths", x: 75, y: 35, connections: [5, 6, 12], region: 0, cleared: false },
        { id: 10, type: "passage", name: "Cinder Basin", x: 32, y: 20, connections: [7, 11], region: 0, cleared: false },
        { id: 11, type: "passage", name: "Hellfire Chasm", x: 55, y: 15, connections: [8, 10, 12, 13], region: 0, cleared: false },
        { id: 12, type: "passage", name: "Eruption Path", x: 78, y: 20, connections: [9, 11], region: 0, cleared: false },
        { id: 13, type: "boss", name: "Dragon Lord's Caldera", x: 42, y: 5, connections: [11], region: 0, cleared: false },
      ],
    },
    2: {
      id: 0,
      ...
      unlocked: true,
      nodes: [
        { id: 0, type: "hut", name: "Ashen Refuge", x: 10, y: 50, connections: [1, 2], region: 0, cleared: false },
        { id: 1, type: "passage", name: "Brimstone Gate", x: 22, y: 75, connections: [0, 3], region: 0, cleared: false },
        { id: 2, type: "passage", name: "Ember Vein", x: 22, y: 28, connections: [0, 5], region: 0, cleared: false },
        { id: 3, type: "passage", name: "Hellmouth Pass", x: 38, y: 85, connections: [1, 4, 6], region: 0, cleared: false },
        { id: 4, type: "shop", name: "Demonsmith Bazaar", x: 38, y: 55, connections: [3, 5, 8], region: 0, cleared: false },
        { id: 5, type: "passage", name: "Molten Abyss", x: 38, y: 18, connections: [2, 4, 7], region: 0, cleared: false },
        { id: 6, type: "passage", name: "Scoriac Plateau", x: 55, y: 78, connections: [3, 9], region: 0, cleared: false },
        { id: 7, type: "shaman", name: "Inferno Sage's Altar", x: 55, y: 12, connections: [5, 10], region: 0, cleared: false },
        { id: 8, type: "rest", name: "Ember Pool", x: 55, y: 45, connections: [4, 9, 10], region: 0, cleared: false },
        { id: 9, type: "passage", name: "Core Tunnels", x: 68, y: 68, connections: [6, 8, 11], region: 0, cleared: false },
        { id: 10, type: "passage", name: "Furnace Heart", x: 68, y: 25, connections: [7, 8, 12], region: 0, cleared: false },
        { id: 11, type: "passage", name: "Apocalypse Rift", x: 80, y: 58, connections: [9, 12, 13], region: 0, cleared: false },
        { id: 12, type: "passage", name: "Annihilation Way", x: 80, y: 35, connections: [10, 11], region: 0, cleared: false },
        { id: 13, type: "boss", name: "Dragon Lord's Throne", x: 92, y: 48, connections: [11], region: 0, cleared: false },
      ],
    },
  },
};
