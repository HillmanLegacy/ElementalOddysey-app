...
export const PARTY_SPRITE_DATA: Record<string, PartySpriteData> = {
  ...
  knight: {
    idle: { sheet: "slknight-idle.png", frameWidth: 128, frameHeight: 64, totalFrames: 8 },
    attack: { sheet: "slknight-attack.png", frameWidth: 128, frameHeight: 64, totalFrames: 9 },
    run: { sheet: "slknight-run.png", frameWidth: 128, frameHeight: 64, totalFrames: 8 },
    hurt: { sheet: "slknight-hurt.png", frameWidth: 128, frameHeight: 64, totalFrames: 4 },
  },
  ranger: {
...
export const ENEMY_POOL: Omit<Enemy, "stats">[] = [
  ...
  { id: "harpy_wind_solo", name: "Harpy", element: "Wind", level: 1, levelRange: [1, 2], xpReward: 18, goldReward: 8, isBoss: false, sprite: "wind", physicalAttack: true },
...
export const REGIONS: Region[] = [
  {
    ...
    nodes: [
      ...
      { id: 1,   type: "village", name: "Thornveil Village",    x: 17, y: 50, connections: [0, 2, 3],    region: 0, cleared: false },
...
export const SPELLS: Spell[] = [
  ...
  { id: "inferno_prayer", name: "Inferno Prayer", description: "A blazing prayer summoning a fire tornado to devastate the target, with scorching embers that burn nearby foes", mpCost: 22, type: "damage", element: "Fire", targetType: "enemy", animation: "infernosPrayer", effect: { damageMultiplier: 1.2 } },
...
export const ELEMENT_SPELL_UNLOCKS: Record<Element, SpellUnlock[]> = {
  Fire: [
    ...
    { spellId: "inferno_prayer", level: 7 },
  ],
  Water: [
...
export const LOOT_ITEMS: Record<string, import("@shared/schema").InventoryItem> = {
  ...
  crystallized_wind_shard: { id: "crystallized_wind_shard", name: "Crystallized Wind Shard",  type: "accessory", description: "−10% Wind damage taken. Pure wind energy crystallized into solid form.", effect: { type: "equip", special: "windResist", specialValue: 0.1 }, icon: "gem",      value: 90, element: "Wind" },
  // Minotaur
  ...
  minotaur_axe:            { id: "minotaur_axe",            name: "Minotaur Axe",             type: "weapon",     description: "+10% ATK. A heavy axe once swung by a minotaur.",                       effect: { type: "equip", percentStat: "atk", percentAmount: 10 }, icon: "axe",      value: 120, element: "Wind" },
  // Cyclops
  ...
  // Resk (boss)
  eye_of_resk:             { id: "eye_of_resk",             name: "Eye of Resk",              type: "accessory", description: "−30% Wind damage taken. The fearsome eye of Resk the Forest Dragon.", effect: { type: "equip", special: "windResist", specialValue: 0.3 }, icon: "eye",      value: 250, element: "Wind" },
  ...
  imbued_wind_gem:         { id: "imbued_wind_gem",         name: "Imbued Wind Gem",          type: "accessory", description: "+10% Wind damage dealt. A gemstone saturated with pure wind magic.", effect: { type: "equip", special: "windBoost", specialValue: 0.1 }, icon: "gem",      value: 200, element: "Wind" },
  // Fire Demon
  ...
  crystallized_fire_shard: { id: "crystallized_fire_shard", name: "Crystallized Fire Shard",  type: "accessory", description: "−10% Fire damage taken. Fire energy crystallized into a hard glowing shard.", effect: { type: "equip", special: "fireResist", specialValue: 0.1 }, icon: "gem",      value: 90, element: "Fire" },
  // Demon Kin
  demons_blade:            { id: "demons_blade",            name: "Demon's Blade",            type: "weapon",    description: "+10% ATK, +10% AGI. A jagged blade carried by a Demon Kin.",        effect: { type: "equip", percentStat: "atk", percentAmount: 10, percentStat2: "agi", percentAmount2: 10 }, icon: "sword",    value: 110, element: "Fire" },
  // Ytriel (dragon_lord)
  ytriels_flame:           { id: "ytriels_flame",           name: "Ytriel's Flame",           type: "accessory", description: "Fire magic +20% dmg & cost. An undying flame torn from the Crown of Cinder.", effect: { type: "equip", special: "fireMagicBoost", specialValue: 0.2 }, icon: "flame",    value: 300, element: "Fire" },
  ...
  imbued_fire_gem:         { id: "imbued_fire_gem",         name: "Imbued Fire Gem",          type: "accessory", description: "Adds Fire element to basic attacks. A gemstone saturated with ancient fire magic.", effect: { type: "equip", special: "fireBasicAttack" }, icon: "gem",      value: 200, element: "Fire" },
