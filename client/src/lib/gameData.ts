...
export const SPELLS: Spell[] = [
  ...
  { id: "inferno_prayer", name: "Inferno Prayer", description: "A blazing prayer summoning fire tornados to scorch all enemies", mpCost: 22, type: "damage", element: "Fire", targetType: "allEnemies", animation: "infernosPrayer", effect: { damageMultiplier: 1.2 } },
