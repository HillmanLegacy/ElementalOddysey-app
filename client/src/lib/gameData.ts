...
export const REGIONS: Region[] = [
  {
    ...
    nodes: [
      ...
      { id: 1,  type: "battle", name: "Scorched Path",        x: 17, y: 50, connections: [0, 2, 3],   region: 0, cleared: false },
      { id: 2,  type: "shaman", name: "Fire Shaman's Hut",    x: 17, y: 25, connections: [1],         region: 0, cleared: false },
      { id: 3,  type: "battle", name: "Cinder Trail",         x: 31, y: 50, connections: [1, 4, 5],   region: 0, cleared: false },
      { id: 4,  type: "battle", name: "Ash Hollow",           x: 31, y: 75, connections: [3],         region: 0, cleared: false },
      { id: 5,  type: "shop",   name: "Merchant Camp",        x: 46, y: 50, connections: [3, 6, 7],   region: 0, cleared: false },
      { id: 6,  type: "battle", name: "Flame Ridge",          x: 46, y: 25, connections: [5],         region: 0, cleared: false },
      { id: 7,  type: "rest",   name: "Hot Spring",           x: 60, y: 50, connections: [5, 8, 9],   region: 0, cleared: false },
      { id: 8,  type: "battle", name: "Lava Flow",            x: 60, y: 75, connections: [7],         region: 0, cleared: false },
      { id: 9,  type: "battle", name: "Inferno Gorge",        x: 74, y: 50, connections: [7, 11, 12, 13], region: 0, cleared: false },
      { id: 11, type: "battle", name: "Magma Cavern",         x: 74, y: 25, connections: [9],         region: 0, cleared: false },
  ...
  0: {
    1: {
      ...
      nodes: [
        ...
        { id: 1, type: "battle", name: "Sulfur Flats", x: 28, y: 72, connections: [0, 4], region: 0, cleared: false },
        { id: 2, type: "battle", name: "Magma Shelf", x: 50, y: 68, connections: [0, 5], region: 0, cleared: false },
        { id: 3, type: "battle", name: "Obsidian Crossing", x: 72, y: 72, connections: [0, 6], region: 0, cleared: false },
        ...
        { id: 6, type: "battle", name: "Pyroclast Ridge", x: 82, y: 52, connections: [3, 9], region: 0, cleared: false },
        { id: 7, type: "battle", name: "Smelter Ruins", x: 22, y: 35, connections: [4, 5, 10], region: 0, cleared: false },
        { id: 8, type: "shaman", name: "Flame Oracle's Cave", x: 55, y: 30, connections: [5, 11], region: 0, cleared: false },
        { id: 9, type: "battle", name: "Crucible Depths", x: 75, y: 35, connections: [5, 6, 12], region: 0, cleared: false },
        { id: 10, type: "battle", name: "Cinder Basin", x: 32, y: 20, connections: [7, 11], region: 0, cleared: false },
        { id: 11, type: "battle", name: "Hellfire Chasm", x: 55, y: 15, connections: [8, 10, 12, 13], region: 0, cleared: false },
        { id: 12, type: "battle", name: "Eruption Path", x: 78, y: 20, connections: [9, 11], region: 0, cleared: false },
    ...
    2: {
      ...
      nodes: [
        ...
        { id: 1, type: "battle", name: "Brimstone Gate", x: 22, y: 75, connections: [0, 3], region: 0, cleared: false },
        { id: 2, type: "battle", name: "Ember Vein", x: 22, y: 28, connections: [0, 5], region: 0, cleared: false },
        { id: 3, type: "battle", name: "Hellmouth Pass", x: 38, y: 85, connections: [1, 4, 6], region: 0, cleared: false },
        { id: 4, type: "shop", name: "Demonsmith Bazaar", x: 38, y: 55, connections: [3, 5, 8], region: 0, cleared: false },
        { id: 5, type: "battle", name: "Molten Abyss", x: 38, y: 18, connections: [2, 4, 7], region: 0, cleared: false },
        { id: 6, type: "battle", name: "Scoriac Plateau", x: 55, y: 78, connections: [3, 9], region: 0, cleared: false },
        ...
        { id: 9, type: "battle", name: "Core Tunnels", x: 68, y: 68, connections: [6, 8, 11], region: 0, cleared: false },
        { id: 10, type: "battle", name: "Furnace Heart", x: 68, y: 25, connections: [7, 8, 12], region: 0, cleared: false },
        { id: 11, type: "battle", name: "Apocalypse Rift", x: 80, y: 58, connections: [9, 12, 13], region: 0, cleared: false },
        { id: 12, type: "battle", name: "Annihilation Way", x: 80, y: 35, connections: [10, 11], region: 0, cleared: false },
